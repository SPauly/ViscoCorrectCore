...
const CorrectionFactors CalculationCTX::Calculate(
  ...
  // Work with an ParametersInternal object internaly.
  ParametersInternal input{
...
const CorrectionFactors CalculationCTX::Calculate(
  ...
  // Work with an ParametersInternal object internaly.
  ParametersInternal input{std::move(_flowrate),  std::move(_head),
...
// Implementations
const ParametersInternal CalculationCTX::ConvertInput(
    const ParametersInternal& input) const noexcept {
